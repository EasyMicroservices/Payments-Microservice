...
namespace EasyMicroservices.PaymentsMicroservice.Clients.Tests
{
...
{""result"":[],""isSuccess"":true,""error"":null}");
        ...
        {
            //await OnInitialize();
            //var microserviceClient = new Payments.GeneratedServices.MicroserviceClient(_routeAddress, HttpClient);
